 ...
 *
 * Priority: this session's prior runtime → agent default → agent-owned
 * workspace. Team-wide cross-session hints are intentionally excluded so a
 * runtime in workspace A from another conversation cannot leak into session B.
 */
