...
impl From<crate::commands::oss_sync::path_validator::PathValidationError> for SyncError {
    fn from(e: crate::commands::oss_sync::path_validator::PathValidationError) -> Self {
