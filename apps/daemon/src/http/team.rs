//! `POST /v1/team/link` — materialize the daemon's team global dir and a
//! workspace `teamclaw-team` symlink on demand.
//!
...
pub async fn link_team_workspace(
    ...
    // Single-team daemon: team_id is fixed at `amuxd init`.
